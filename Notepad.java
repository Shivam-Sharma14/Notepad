...
public abstract class Notepad extends JFrame implements ActionListener{
    ...
    Notepad(){
        ...
        // Set Icon Image of Notepad
        ImageIcon notepadIcon = new ImageIcon(ClassLoader.getSystemResource("notepad/icon/notepad.jpg"));
        ...
        // Set font and size of menu file
        ...
        // class For Scroll Bar in Text Area 
